...
import com.impv.comm.httpclient.HttpResult;
...
public class ApiService implements BeanFactoryAware {
    ...
    public HttpResult doPost(String url, Map<String, String> params) throws IOException {
        ...
        CloseableHttpResponse response = null;
        return getHttpResult(httpPost, response);
    }

    private HttpResult getHttpResult(HttpPost httpPost, CloseableHttpResponse response) throws IOException {
        try {
            // 执行请求
